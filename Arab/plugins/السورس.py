...
fahs = """‎✰︎┊𝙼𝚈 𖠄 {my_mention} ٫
‌‎✰︎┊𝙱𝙾𝚃 𖠄 {tg_bot} ٫
‌‎✰︎┊𝚃𝙸𝙼𝙴 𖠄 {TM} ٫
‌‎✰︎┊𝚄𝙿𝚃𝙸𝙼𝙴 𖠄 {uptime} ٫
‌‎✰︎┊‌‎𝙿𝙸𝙽𝙶 𖠄 {ping} ٫
‌‎✰︎┊‌‎𝚅𝙴𝚁𝚂𝙸𝙾𝙽 𖠄 (7.7) ,
‌‎✰︎┊𝚂 𝙰 𝙼 𝙸 𝚁 𖠄 @DEV_SAMIR """
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/FTTUTY  ⦒
""")
@iqthon.on(admin_cmd(pattern="م16(?: |$)(.*)"))    
async def iq(event):
    await edit_or_reply(event, 
"""** ⦑   اوامر الملصقات   ⦒  : **
╔━━━⊶⛧• [𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙴𝙼𝙾](t.me/FTTUTY) •⛧⊶━━╗
...
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت سيمو لديك 
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات بوت سيمو
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته  
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع بوت سيمو
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء سورس سيمو بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل سورس سيمو
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .الاوامر ) 
...
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك بوت الشيطان
•┈┉━☾︎  𝘴ꪮꪊ𝘳ᥴꫀ 𝘴ꫀꪑꪮ  ☽︎━┅┈•
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه بوت الشيطان بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
المطور : ( @DEV_SAMIR ) .
قناه السورس : ( @FTTUTY ) .
اهــتــمــامــي حــلــو بــس اهــمــالــي أجــمــد💆🏻‍♀️💋 """)
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @pp_g3 \n**🝳︙ شـرح اوامـر السـورس : @CR_8DR_SH**\n**🝳︙ شـرح بار السـورس : @gro_up_1** "
