...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/0fd4f15e79afdbc03e8df.jpg", caption="🝳 ⦙ تـمّ  اعـادة تشـغيل\n سورس سيمو ✓  :  [ 7.7 ] .\n\n🝳 ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) ",                buttons=[(Button.url("مطور سورس سيمو الرسمي", "https://t.me/DEV_SAMIR"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "✰︎ جـروب إشـعـارات سـيـمـو ✰︎", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "✰︎ جـروب تـخـزيـن سـيـمـو ✰︎", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
